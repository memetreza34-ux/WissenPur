...
Diese Functions verwalten die wettbewerbsrelevanten Werte der Lern-App. Browsercode darf keine Ranglistenpunkte, Münzen, Erfolge, Shopbestände oder täglichen Belohnungen als vertrauenswürdig festlegen.
...
- berechnet Punkte, Münzen und Erfolge im Backend
...
Die bestehende monolithische Quizansicht übermittelt vorübergehend nur die begrenzten Werte `correct` und `total`. Der Endpunkt ignoriert clientseitige Punktwerte, berechnet Belohnungen und Erfolge selbst, verwendet einmalige Rundennachweise und begrenzt schnelle Mehrfacheinreichungen.
...
Alle Änderungen laufen als Firestore-Transaktionen. Preise, tägliche Limits, Erfolgsprämien und Glücksrad-Zufall stammen aus dem Backend.
...
Die erste erfolgreiche vertrauenswürdige Wirtschaftsfunktion setzt `economyVersion: 1`. Ab dann dürfen Browser nur noch Profil, Einstellungen und eigene Lerninhalte ändern. Punkte, Münzen, Serien, Erfolge, Power-ups, Shopfreischaltungen und Rangliste gehören den Cloud Functions.
